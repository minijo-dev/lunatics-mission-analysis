...
// To compile atm
//g++ ads_integrated2.cpp ads_functions.cpp -I /usr/include/eigen3 -o ads_program2
...
int main() {
    ...
    file_state << "q0 q1 q2 q3 wx wy wz\n";
    ...
    for (int count = 0; count < timesteps; ++count) {
        ...
        if (bool initalise = true){
            ...
            init_state = QUEST(a_known, m_known, acc_meas, mag_meas, Constant);
        ...
        // EKF //
        EKFResult ekf_result = ekf(init_state, init_P, mag_dec_meas, prop_time, dt, new_meas, Constant);
